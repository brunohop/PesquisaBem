...
class VeiculosControllerTest < ActionController::TestCase
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post :create, veiculo: { ano: @veiculo.ano, cidade: @veiculo.cidade, cri: @veiculo.cri, marca: @veiculo.marca, modelo: @veiculo.modelo, observacoes: @veiculo.observacoes, placa: @veiculo.placa, uf: @veiculo.uf }
    end
  ...
  test "should update veiculo" do
    patch :update, id: @veiculo, veiculo: { ano: @veiculo.ano, cidade: @veiculo.cidade, cri: @veiculo.cri, marca: @veiculo.marca, modelo: @veiculo.modelo, observacoes: @veiculo.observacoes, placa: @veiculo.placa, uf: @veiculo.uf }
    assert_redirected_to veiculo_path(assigns(:veiculo))
  end
