...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { cidade: @empresa.cidade, cnpj: @empresa.cnpj, razaoSocial: @empresa.razaoSocial, uf: @empresa.uf }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { cidade: @empresa.cidade, cnpj: @empresa.cnpj, razaoSocial: @empresa.razaoSocial, uf: @empresa.uf }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
