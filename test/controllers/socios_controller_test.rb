...
class SociosControllerTest < ActionController::TestCase
  ...
  test "should create socio" do
    assert_difference('Socio.count') do
      post :create, socio: { administrador: @socio.administrador, cpf: @socio.cpf, dataNascimento: @socio.dataNascimento, nome: @socio.nome }
    end
  ...
  test "should update socio" do
    patch :update, id: @socio, socio: { administrador: @socio.administrador, cpf: @socio.cpf, dataNascimento: @socio.dataNascimento, nome: @socio.nome }
    assert_redirected_to socio_path(assigns(:socio))
  end
